...
//classe para devolver o erro bem explicado
@ControllerAdvice
public class ControllerExceptionHandler extends ResponseEntityExceptionHandler{
	...
	protected ResponseEntity<Object> handleUsuarioException(UsuarioException ex) {
		...
		ErroResposta erroResposta = new ErroResposta(HttpStatus.UNPROCESSABLE_ENTITY.value(), "Existem campos inválidos", LocalDateTime.now(),
				erros);
